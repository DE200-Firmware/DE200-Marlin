...
/**
 * Comprehensive auto-generated firmware for the Dagoma DiscoEasy200,
 * with all standard Dagoma variants and some common community variants,
 * in all languages provided by Marlin,
 * and with both Dagoma special pinouts and MKS Base standard pinouts.
 *
 * The default configuration file is for the most common stock
...
// DE200_SPECIAL_* - default NONE; available NONE, BASIC, SERIAL_DEBUG, BED_BILINEAR, PID, CLASSIC_JERK, NO_S_CURVE, NO_ADAPTIVE_SMOOTHING, FT_MOTION, STATUS_ICONS

// NONE - All default software options
//#define DE200_SPECIAL_NONE
// BASIC - Use for Input shaping measurements - LINEAR_ADVANCE/INPUT_SHAPING off, CLASSIC_JERK not JUNC_DEV, no S_CURVE/ADAPTIVE_SMOOTHING/XY_FREQ/FT_MOTION
...
//#define DE200_SPECIAL_NO_ADAPTIVE_SMOOTHING
//#define DE200_SPECIAL_FT_MOTION
 ...
 */
  ...
  DE200_SPECIAL_PID, DE200_SPECIAL_CLASSIC_JERK, DE200_SPECIAL_NO_S_CURVE, DE200_SPECIAL_XY_FREQ, \
  DE200_SPECIAL_NO_ADAPTIVE_SMOOTHING, DE200_SPECIAL_FT_MOTION, DE200_SPECIAL_STATUS_ICONS)
  #define DE200_SPECIAL_NONE
#endif
#if NONE(DE200_SPECIAL_BED_BILINEAR, DE200_SPECIAL_BED_UNIFIED)
  #define DE200_SPECIAL_BED_LINEAR
#endif
#if DISABLED(DE200_SPECIAL_BASIC)
  #define DE200_SPECIAL_ADVANCED
#endif
#if DISABLED(DE200_SPECIAL_PID)
  #define DE200_SPECIAL_MPC
#endif
#if DISABLED(DE200_SPECIAL_CLASSIC_JERK)
  #define DE200_SPECIAL_JUNCTION_DEVIATION
#endif
#if DISABLED(DE200_SPECIAL_NO_S_CURVE)
  #define DE200_SPECIAL_S_CURVE
#endif
#if DISABLED(DE200_SPECIAL_XY_FREQ)
  #define DE200_SPECIAL_NO_XY_FREQ
#endif
#if DISABLED(DE200_SPECIAL_NO_ADAPTIVE_SMOOTHING)
  #define DE200_SPECIAL_ADAPTIVE_SMOOTHING
#endif
#if DISABLED(DE200_SPECIAL_FT_MOTION)
  #define DE200_SPECIAL_NO_FT_MOTION
#endif
 ...
 */
  ...
  // Advanced Marlin features
    ...
    #define MACHINE_ABOUT_LINE3 "Sp: No S-Curve Acc."
  #elif ENABLED(DE200_SPECIAL_XY_FREQ)
    #define MACHINE_ABOUT_LINE3 "Sp: XY Freq Limit"
  #elif ENABLED(DE200_SPECIAL_NO_ADAPTIVE_SMOOTHING)
    #define MACHINE_ABOUT_LINE3 "Sp: No Adapt. Smooth."
...
#define STRING_CONFIG_H_AUTHOR "by Sophist-UK" // Who made the changes.
...
// Choose the name from boards.h that matches your setup
    ...
    #define MOTHERBOARD BOARD_DAGOMA_D6
  #else
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // Explanation of how following values were obtained at:
 ...
 */
  ...
  // Dagoma DiscoEasy200 heated bed taken from DiscoUltimate
  // https://github.com/dagoma3d/Marlin-By-Dagoma/blob/master/LinuxAddons/Dagoma/conf/serie/Ultimate/Base
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 1000, 25, 10000 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 3500, 1500, 50, 20000 } // ...or, set your own edit limits
#endif
 ...
 */
#if ALL(DE200_SPECIAL_ADVANCED,DE200_SPECIAL_S_CURVE)
 ...
 */
#if NONE(DE200_HEAD_BLTOUCH_ANY)
