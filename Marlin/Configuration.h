...
// DE200_SPECIAL_* - default NONE; available NONE, BASIC, SERIAL_DEBUG, BED_BILINEAR, PID, CLASSIC_JERK, S_CURVE, ADAPTIVE_SMOOTHING, FT_MOTION, STATUS_ICONS
 ...
 */
  ...
  DE200_SPECIAL_PID, DE200_SPECIAL_CLASSIC_JERK, DE200_SPECIAL_S_CURVE, DE200_SPECIAL_XY_FREQ, \
...
#endif
#if DISABLED(DE200_SPECIAL_S_CURVE)
 ...
 */
  ...
  #elif ENABLED(DE200_SPECIAL_S_CURVE)
    #define MACHINE_ABOUT_LINE3 "Sp: S-Curve Accel."
 ...
 */
#if NONE(DE200_SPECIAL_BASIC, DE200_SPECIAL_S_CURVE)
