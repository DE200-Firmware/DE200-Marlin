...
#define HOMING_BACKOFF_POST_MM { 3, 3, 5 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
#define INPUT_SHAPING_Y
    ...
    // 2. marlinfw to double check the frequencies and determining the damping factor
      ...
      #define SHAPING_FREQ_X  37.42f    // (Hz) The default dominant resonant frequency on the X axis.
    ...
    #if ENABLED(INPUT_SHAPING_X)
      #define SHAPING_FREQ_X   0.00f    // (Hz) The default dominant resonant frequency on the X axis.
      #define SHAPING_ZETA_X   0.00f    // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
    #endif
    #if ENABLED(INPUT_SHAPING_Y)
      #define SHAPING_FREQ_Y   0.00f    // (Hz) The default dominant resonant frequency on the Y axis.
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 5*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define BABYSTEPPING
  ...
  #if ALL(BABYSTEP_ZPROBE_OFFSET, DE200_SCREEN_ANY)
...
#define MIN_STEPS_PER_SEGMENT 5 // Dagoma
...
#define FWRETRACT
  ...
  //#define FWRETRACT_AUTORETRACT             // Override slicer retractions
    ...
    #define MAX_AUTORETRACT              8.0  // (mm) Don't convert E moves over this length
  #endif
  #define RETRACT_LENGTH                 4.5  // (mm) Default retract length (positive value)
...
// Custom Menu: Main Menu
  ...
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 G26 Mesh Validation OK."
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_MAIN_SCRIPT_RETURN     // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Print Mesh Validat."
